...
const CategoryCard = ({ label, color, icon, onClick }: CategoryCardProps) => (
    <div
        onClick={onClick}
        className={`flex-shrink-0 w-[160px] h-[100px] rounded-xl ${color} p-4 relative overflow-hidden cursor-pointer hover:shadow-md hover:scale-105 transition-all duration-200`}
    >
        ...
        <ChevronRight className="absolute bottom-3 right-3 w-4 h-4 text-foreground/40" />
    </div>
);
        ...
        <div className="px-8 py-8 space-y-12 pb-20">
            ...
            <section>
                ...
                <div className="flex gap-4 overflow-x-auto pb-4 scrollbar-hide">
                    <CategoryCard label="Presentation" color="bg-orange-100" onClick={() => handleCategoryClick("Presentation")} />
                    <CategoryCard label="Poster" color="bg-purple-100" onClick={() => handleCategoryClick("Poster")} />
                    <CategoryCard label="Resume" color="bg-blue-100" onClick={() => handleCategoryClick("Resume")} />
                    <CategoryCard label="Email" color="bg-indigo-100" onClick={() => handleCategoryClick("Email")} />
                    <CategoryCard label="Logo" color="bg-yellow-100" onClick={() => handleCategoryClick("Logo")} />
                    <CategoryCard label="Flyer" color="bg-pink-100" onClick={() => handleCategoryClick("Flyer")} />
                    <CategoryCard label="Instagram Post" color="bg-red-50" onClick={() => handleCategoryClick("Instagram Post")} />
                    <CategoryCard label="Instagram Story" color="bg-pink-50" onClick={() => handleCategoryClick("Instagram Story")} />
                    <CategoryCard label="Video" color="bg-emerald-50" onClick={() => handleCategoryClick("Video")} />
                    <CategoryCard label="Invitation" color="bg-violet-100" onClick={() => handleCategoryClick("Invitation")} />
                </div>
            </section>
