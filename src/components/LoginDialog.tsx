            ...
            <DialogContent className="sm:max-w-md">
                <DialogHeader>
                    <DialogTitle className="flex items-center gap-2">
                        ...
                        {isSignUp ? "Create Account" : "Sign in to Save"}
                    </DialogTitle>
                </DialogHeader>
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <Button variant="outline" type="button" size="sm" onClick={handleGoogleLogin}>
                        ...
                        <Button variant="outline" type="button" size="sm" onClick={handleGitHubLogin}>
